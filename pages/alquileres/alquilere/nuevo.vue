                  ...
                  <div slot="body" class="row">
                    ...
                    <div class="form-group col-12">
                      ...
                      <select name="" id="" class="form-control" v-model="model.cliente_id">
                        <option v-for="m in clientes" :value="m.id">{{ m.carnet }}</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group col-12">
                      ...
                      <select name="" id="" class="form-control" v-model="model.categoria_id"disabled>
                    ...
                    <!-- <div class="form-group col-12">
                      ...
                      <select name="" id="" class="form-control" v-model="model.casilla_id">
                        <option v-for="m in casillas" :value="m.id">{{ m.estado }}</option>
                      </select>
                    </div> -->
                    <div class="form-group col-12">
